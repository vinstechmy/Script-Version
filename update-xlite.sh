...
cd /usr/bin
wget -O add-host "https://raw.githubusercontent.com/vinstechmy/XRAY-Lite/main/SSH/add-host.sh" && chmod +x add-host
wget -O certxray "https://raw.githubusercontent.com/vinstechmy/XRAY-Lite/main/XRAY/cert.sh" && chmod +x certxray
